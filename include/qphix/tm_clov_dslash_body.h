...
template <typename FT, int veclen, int soalen, bool compress12>
void TMClovDslash<FT, veclen, soalen, compress12>::Dyz(
    int tid,
    const FourSpinorBlock *psi,
    FourSpinorBlock *res,
    const SU3MatrixBlock *u,
...
template <typename FT, int veclen, int soalen, bool compress12>
void TMClovDslash<FT, veclen, soalen, compress12>::DyzAChiMinusBDPsi(
    int tid,
    const FourSpinorBlock *psi,
    const FourSpinorBlock *chi,
    FourSpinorBlock *res,
    ...
    int fl)
{
  auto kernel =
      (is_plus
           ? QPHIX_KERNEL_SELECT(
                 tm_clov_dslash_achimbdpsi_plus_vec, FT, veclen, soalen, compress12)
           : QPHIX_KERNEL_SELECT(tm_clov_dslash_achimbdpsi_minus_vec,
                                 FT,
                                 veclen,
                                 soalen,
                                 compress12));
...
template <typename FT, int veclen, int soalen, bool compress12>
void TMClovDslash<FT, veclen, soalen, compress12>::DPsi(
    const SU3MatrixBlock *u,
    const FullCloverBlock *invclov,
